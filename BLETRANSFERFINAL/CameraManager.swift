...
class CameraManager: ObservableObject, CaptureDataReceiver {
    ...
    // Add a published property to store the processed array
    @Published var processedDepthArray: [[String]] = []
    ...
    // Implement the required method from the CaptureDataReceiver protocol
        func onProcessedArrayData(processedArray: [[String]]) {
            DispatchQueue.main.async {
                // Update the published property with the new processed array
                self.processedDepthArray = processedArray
            }
        }
